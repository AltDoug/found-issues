...
**5 lifecycle hooks · 13 slash commands · 769 tests on Linux/macOS/Windows · zero manual bookkeeping**
...
**v2.5.0** — actively developed and dogfooded (this repo's own ledger is
