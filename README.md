...
**5 lifecycle hooks · 13 slash commands · 767 tests on Linux/macOS/Windows · zero manual bookkeeping**
...
**v2.4.0** — actively developed and dogfooded (this repo's own ledger is
